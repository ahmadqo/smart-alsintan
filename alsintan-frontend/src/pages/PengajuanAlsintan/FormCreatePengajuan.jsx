...
const FormCreatePengajuan = ({ isOpen, onClose, onSuccess }) => {
  ...
  const [alsintanList, setAlsintanList] = useState([
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      onSuccess("Pengajuan berhasil disimpan");
      onClose();
      resetForm();
    } catch (error) {
...
export default FormCreatePengajuan;
